    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-8 lg:p-12">
      ...
      <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-xl overflow-hidden max-w-5xl w-full lg:h-[600px]">
        ...
        >
          ...
          <a href="https://www.linkedin.com/company/ieee-student-branch-rajagiri-school-of-engineering-technology/" className="hover:text-white transition-colors">
          ...
          <a href="https://www.instagram.com/ieeersetsb?igsh=cThsZHhwOG52YmEx" className="hover:text-white transition-colors">
          ...
          <a href="mailto:ieee@rset.edu.in" className="hover:text-white transition-colors">
